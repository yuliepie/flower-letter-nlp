  ...
  return (
    <div>
      ...
      <HStack h='70vh' p='2' ml='5' mr='5' align='center' justify='center'>
        ...
        <VStack justify='center' w='40%' h='100%' border='1px' borderRadius='10px' ml='1' p='4'>
          {/* 오른쪽 박스 - 키워드 비율 조절 */}
          <HStack display='flex' m='1' p='2' mb='0' w='100%' h='65%' align='center' border='1px'>
          ...
          <HStack m='1' mt='0' p='2' w='100%' h='12%' align='center' border='1px' fontSize='1.5vw'>
