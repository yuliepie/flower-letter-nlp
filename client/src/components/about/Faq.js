...
import { Stack,Flex,Button,Text,VStack,useBreakpointValue,Box, Accordion, AccordionButton,AccordionItem,AccordionIcon,AccordionPanel, List, ListIcon, ListItem } from "@chakra-ui/react";
                  ...
                  <h2>
                    <AccordionButton>
                      <Box flex='1' textAlign='center'>
                        <Text fontSize='3xl' color="white">자주묻는 질문을 확인해보세요</Text>
                      </Box>
