...
dataset_train = nlp.data.TSVDataset(
    "../dataset/letter_single_train.tsv", field_indices=[0, 1], num_discard_samples=1
)
dataset_test = nlp.data.TSVDataset(
    "../dataset/letter_single_train.tsv",
    field_indices=[0, 1],
...
class BERTClassifier(nn.Module):
    def __init__(
        self, bert, hidden_size=768, num_classes=26, dr_rate=None, params=None  # 클래스 수
    ):
...
MODEL_PATH = "../models/kobert_letter_single.pkl"
